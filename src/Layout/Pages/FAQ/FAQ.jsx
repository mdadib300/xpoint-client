...
const FAQ = () => {
    return (
        <div className='mx-10 mb-10'>
            ...
            <h1 className="font-semibold text-center text-2xl lg:text-3xl my-10">Frequently Asked Questions</h1>
            ...
            <div className="collapse collapse-arrow mb-2 md:mb-4">
                ...
                <div className="collapse-content text-sm">Yes, we do! You can shop in person at our offline outlet, try products before buying, and enjoy personalized service. Our outlet location: Minnat Plaza, Shop no.: 101, 102, 103, Abdullahpur Bazar, South Keraniganj, Dhaka - 1310</div>
            </div>
            <div className="collapse collapse-arrow mb-2 md:mb-4">
                <input type="radio" name="my-accordion-2" />
